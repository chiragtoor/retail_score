...
export default class SRPSearchBar extends Component {
  ...
  render () {
    ...
    return (
      <div style={{height:"100%", width:"100%", backgroundColor:"#9b59b6"}}>
        <FormGroup style={{height:"100%", width:"100%"}}>
          <InputGroup style={{height:"100%", width:"100%", position:"relative"}}>
           <div style={{height:"100%"}} className="homepageSearchBar" > 
