...
export default class MobileLastTile extends Component {
  ...
  render () {
    ...
    return (
            <div className="hidden-sm text-center horizontalPDPTiles" style={{display:"inline-block", position:"relative", border:"solid thin #7f8c8d", height:"130px", marginLeft:"0px", padding:"0px", overflowY:"hidden"}}>
              <Button onClick={this.props.userClick} style={{fontSize:"20px", backgroundColor:"#FFFFFF", color:"#7f8c8d", height:"100%"}}>Back<br/> <em className="fa fa-arrow-left"></em></Button>
            </div>
    );
  }
}
