...
export default class MobilePropertyTile extends Component {
  ...
  render () {
    ...
    return (
          <div className="hidden-sm panel b text-center horizontalPDPTiles" style={{display:"inline-block", position:"relative", height:"130px", width:"85%", padding:"0px", overflowY:"hidden"}} onClick={this.tileClick}>
